...
figure(6); set(gcf,'Position', [0, 400, 2000, 200]);
=======
>>>>>>> a6440449853d84de3db02c17a88fd0f2378c0435
...
subplot(1,5,2); heatmap(Norm_M); clim([0.4 0.8]); title('Motor');
subplot(1,5,3); heatmap(Norm_S); clim([0.4 0.8]); title('Somatosensory');
subplot(1,5,4); heatmap(Norm_V); clim([0.4 0.8]); title('Visual');
subplot(1,5,5); heatmap(Norm_RSP); colormap jet; clim([0.4 0.8]); title('Retrosplenial');
=======
figure(10); set(gcf,'Position', [0, 400, 2000, 200]);
>>>>>>> 6b8e9f1 (Meso2P)
>>>>>>> 7a3fd0b (20260626)
